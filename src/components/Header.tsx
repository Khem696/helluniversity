...
export function Header() {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 px-2 xxs:px-3 phone:px-4 lg:px-8 py-2 xxs:py-3 phone:py-4 lg:py-6">
      {/* Top Row */}
      <div className="flex items-center justify-between max-w-[1920px] mx-auto mb-0 lg:mb-0">
        {/* Logo */}
        ...
        {/* Title */}
        <h1 className="text-center hidden xxs:block font-heading" style={{ fontSize: 'clamp(48px, 7vw, 79px)', fontWeight: '800', letterSpacing: '0.02em' }}>
