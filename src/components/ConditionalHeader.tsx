...
export function ConditionalHeader() {
  ...
  useEffect(() => {
    ...
    // Hide main header on all admin pages and booking response pages
    if (pathname?.startsWith("/admin") || pathname?.startsWith("/booking/response")) {
  ...
  // Hide main website header on all admin pages and booking response pages
  // Admin pages have their own layout with separate header
  // Booking response pages should be standalone without header
  if (pathname?.startsWith("/admin") || pathname?.startsWith("/booking/response")) {
    return null
  }
