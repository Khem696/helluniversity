 ...
 * 
 * POST /api/v1/booking/deposit - Upload deposit evidence image
 * - Updates booking status to "paid_deposit" after upload
 * - Status remains "paid_deposit" after upload (admin needs to review)
 * 
 * Body (FormData):
  ...
  return withErrorHandling(async () => {
    ...
    try {
      ...
      return errorResponse(
        ...
        "Your session expired during the upload process. The image was uploaded successfully, but the booking could not be updated. Please contact support with your booking reference number.",
        {
