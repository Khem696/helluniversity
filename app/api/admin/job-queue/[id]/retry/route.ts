/**
 * Admin Job Queue Retry Endpoint
 * 
...
/**
 * POST /api/admin/job-queue/[id]/retry
...
export async function POST(
  ...
  return withErrorHandling(async () => {
    ...
    const logger = createRequestLogger(requestId, '/api/admin/job-queue/[id]/retry')
  ...
  }, { endpoint: '/api/admin/job-queue/[id]/retry' })
}
