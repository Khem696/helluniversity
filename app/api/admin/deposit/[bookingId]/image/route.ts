...
/**
 * Deposit Image Proxy (Admin Access)
 * 
 * GET /api/admin/deposit/[bookingId]/image
 * - Validates admin authentication
 * - Streams deposit evidence image securely
 * - Only accessible to authenticated admins
 * 
 * This endpoint provides secure access to deposit images for admin users.
 */
...
export async function GET(
  ...
  const logger = createRequestLogger(requestId, '/api/admin/deposit/[bookingId]/image')
